...
# ffmpeg -deinterlace -i sample_kinect.avi -async 1 -vcodec h263 -s 352x288 -maxrate 20000k -b:v 19500k -qmin 3 -qmax 5 -bufsize 1000000 -acodec pcm_s16be -ar 32000 -ab 160k -ac 2 -y sample_kinect.anvil.mov
done <"$file"